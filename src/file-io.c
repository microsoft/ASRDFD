...
#endif
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6,5,0) || defined(SLES15SP6) || defined(SLES15SP7)
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6,5,0) || defined(RHEL9_6) || defined(SLES15SP6) || defined(SLES15SP7)
